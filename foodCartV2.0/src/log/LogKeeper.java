...
/**
 * @author Vimal
 * This is the Singleton Logger.
 * We use the java.util.logging classes to execute logging
 * logger is the logging object, and logKeeper is the interface in FoodCart for logger
 * Serializing is handled by the LogManager
 */
...
/*
 * This method adds a Fine level log entry. it calles the logger to add the entry
 * We do some formatting here, rest is taken care by the LogFormatter.
 */
	...
	/*
	 * This method adds a Severe level log entry. it calles the logger to add the entry
	 * We do some formatting here, rest is taken care by the LogFormatter.
	 */
